...
myStyle  = openxlsx::createStyle()
italicStyle = openxlsx::createStyle(textDecoration="Italic",fontColour="green")
alertStyle = openxlsx::createStyle(textDecoration="Bold",fontColour="red")

fillCells(cells, 17 , 2 , "Cases in green", style=italicStyle)
if (value > 10) {
  myStyle = alertStyle
} 
