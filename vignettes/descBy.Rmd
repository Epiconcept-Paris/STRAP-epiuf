...
Various rounding options are possible based on the argument "digits".
...
table <- descBy(data = df, vars = c("age", "agegp4", "sex", "fluvaccany"), digits = 1)
kable(table)

# Example
table <- descBy(data = df, 
                vars = c("age", "agegp4", "sex", "fluvaccany"),
                labels = c("Age", "Age in group", "Sex", "Seasonal influenza vaccination"), digits = 1)
kable(table)
```
