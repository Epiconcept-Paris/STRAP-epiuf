...
printIf() : output for bullet point in rmd. Prints given caption, the count of records and list of Ids in string format if under a specified threshold. 1 or 2 data set entry possible.

printKableIf() : output for kable in rmd. Prints given caption, the count of records and list of Ids in string format if under a specified threshold for group of input conditions and captions into a table with a header. 1 or 2 data set entry possible.
